// Cargar y mostrar productos de cuidado de la piel con carga progresiva por scroll
            ...
            html += `
                <div class="featured-product-card" onclick="verProducto('${producto.id}')">
                    <a href="producto.html?id=${producto.id}" class="featured-product-card__img-link" onclick="event.stopPropagation()">
                        ...
                        <span class="featured-product-card__tag">Piel</span>
                        ${isNuevo ? '<span class="featured-product-card__badge-nuevo">Nuevo</span>' : ''}
                    </a>
